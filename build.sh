...
ARM64_PATH="$BUILD_DIR/arm64-apple-macosx/release/WNBASchedule"
X86_64_PATH="$BUILD_DIR/x86_64-apple-macosx/release/WNBASchedule"
UNIVERSAL_BINARY="$UNIVERSAL_OUTPUT/WNBASchedule"
